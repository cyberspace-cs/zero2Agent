...
> 来源：蚂蚁集团 Agent 开发一面 / [OPPO IT 开发一面](https://www.nowcoder.com/discuss/923561467092160512)【[拼多多 - Agent 开发岗（工程化 + 数据库）](https://www.nowcoder.com/discuss/926273867092430848)追问：大规模代码场景的上下文维护？】
...
实际组装上下文时，先建立轻量 repo map，根据当前符号的定义、引用、类型和测试关系渐进展开，而不是一次读全仓库。每次编辑后使旧索引失效，重跑定向搜索和测试；当依赖边界或生成代码无法验证时，停止扩大修改范围并请求补充证据。
